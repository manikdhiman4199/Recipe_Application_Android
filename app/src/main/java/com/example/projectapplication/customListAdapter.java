...
public class customListAdapter extends ArrayAdapter<RecipesListModel> {

    private Context mcontext;
    private List<RecipesListModel> recipeList = new ArrayList<>();

    public customListAdapter(@NonNull Context context, List<RecipesListModel> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        RecipesListModel currentRecipe = recipeList.get(position);
