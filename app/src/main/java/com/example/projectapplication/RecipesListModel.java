...
public class RecipesListModel extends RealmObject {
    ...
    public RecipesListModel(int recipeImg, String recipeTitle, String duration, String tags, String recipeProcedure) {
